...
<h3><?php echo VIEW_LABEL_HEADING_EXPIRED_COURSES;?></h3>
  <table width="100%" border="1" cellpadding="3" cellspacing="3">
	...
	$i=0;
	 ...
	 ?>
    <tr class="<?php echo $row_bg; ?>">
      <td><?php echo $row_RsCoursesList_Expired['SubjectTitle']; ?></td>
      <td><?php echo $row_RsCoursesList_Expired['CourseName']; ?></td>
      <td><?php echo $row_RsCoursesList_Expired['Description']; ?></td>
      <td class="small"><?php echo $row_RsCoursesList_Expired['StartDate']; ?></td>
      <td class="small"><?php echo $row_RsCoursesList_Expired['EndDate']; ?></td>
      <td class="small"><?php echo $row_RsCoursesList_Expired['CourseFee']; ?></td>
      </tr>
    <?php } while ($row_RsCoursesList_Expired = mysql_fetch_assoc($RsCoursesList_Expired)); ?>
    </table>
</div>
