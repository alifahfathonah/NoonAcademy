	...
	$i=0;
	 ...
	 ?>
      <tr class="<?php echo $row_bg; ?>">
		...
		<td><?php echo $row_Rs_GetMyClasses['WizIQ_start_time']; ?></td>        
...
<h3>Expired Classes </h3>
<?php if($totalRows_Rs_GetMyClasses_Expired>0){ ?>
 <div class="detail_view">
  <p>&nbsp;</p>
<table width="100%" border="1" cellpadding="3" cellspacing="3">
  <tr  class="header_caption_row">
	...
	$i=0;
	 ...
	 ?>
      <tr class="<?php echo $row_bg; ?>">
        <td><?php echo $row_Rs_GetMyClasses_Expired['CourseName']; ?></td>
        <td><?php echo $row_Rs_GetMyClasses_Expired['WizIQ_class_id']; ?></td>
        <td><?php echo $row_Rs_GetMyClasses_Expired['WizIQ_screen_name']; ?></td>
		<td><?php echo $row_Rs_GetMyClasses_Expired['WizIQ_start_time']; ?></td>        
        <td><?php echo $row_Rs_GetMyClasses_Expired['CreateAt']; ?></td>
        <td><?php echo $row_Rs_GetMyClasses_Expired['UpdatedAt']; ?></td>
      </tr>
      <?php } while ($row_Rs_GetMyClasses_Expired = mysql_fetch_assoc($Rs_GetMyClasses_Expired)); ?>
  </table>
</div>
<?php }else {// end of if $totalPages_Rs_GetMyClasses
fnShowMessageBox(MSG_STUDENT_NOT_ENTROLLED_TO_ANY_CLASS,MSG_TITLE_STUDENT_NOT_ENTROLLED_TO_ANY_CLASS); 
...
mysql_free_result($Rs_GetMyClasses_Expired);
