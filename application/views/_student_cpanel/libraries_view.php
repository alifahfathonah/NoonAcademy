	...
	$i=0;
	 ...
	 ?>
      <tr class="<?php echo $row_bg; ?>">
        <td>
        <?php 
		if($row_Rs_GetLibrary['IsPaid']==1){
			?>
        <a href="<?php echo USER_LIBRARY_UPLOAD_PATH.$row_Rs_GetMeterialUploadList['DataFileName'] ; ?>" target="_blank"><img src="images/icons/download.png" width="16" height="16"></a>
        <?php }else{ ?>
       <img src="images/icons/lock.gif" width="16" height="16">
        <?php } ?>
