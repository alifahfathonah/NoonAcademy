...
<table width="100%" border="1" cellpadding="3" cellspacing="3">
   <tr class="header_caption_row">
     <td colspan="3" align="center" valign="middle"><form id="form1" name="form1" method="post" action="?page_id=_teacher_cpanel/teacher_courses_schedule_new" accept-charset="utf-8">
   ...
   <tr class="header_caption_row">
    ...
    <td><a href="?page_id=view_course_class_datesheet&CourseID=<?php echo $row_RsGetTeachersSecheduleList['CourseID']; ?>"><img src="images/icons/view_dates.png" width="16" height="16" /></a></td>
      ...
      <td><?php echo $row_RsGetTeachersSecheduleList['MaxNoOfStudent']; ?></td>
      <td><?php echo $row_RsGetTeachersSecheduleList['TotalNoOfClasses']; ?></td>
      <td><?php echo $row_RsGetTeachersSecheduleList['CourseFee']; ?></td>
      </tr>
