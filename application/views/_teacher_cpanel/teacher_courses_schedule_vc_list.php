...
<p>&nbsp;</p>
<h3><?php echo VIEW_LABEL_HEADING_EXPIRED_CLASSES; ?></h3>
 <!-- Start of Expired Classes -->
 <?php if ($totalRows_RsGetMyScheduledClasses_Expired>0){ ?>
<div class="detail_view">
<table width="100%" border="1" cellpadding="3" cellspacing="3">
    <tr class="header_caption_row">
    <td><?php echo VIEW_LABEL_COURSE_NAME;?></td>
	...
	$i=0;
	 ...
	 ?>
      ...
      <td><?php echo $row_RsGetMyScheduledClasses_Expired['WizIQ_class_id']; ?></td>
      <td><?php echo $row_RsGetMyScheduledClasses_Expired['WizIQ_start_time']; ?></td>
      <td><?php echo $row_RsGetMyScheduledClasses_Expired['WizIQ_duration']; ?></td>
      <td><a href="<?php echo $row_RsGetMyScheduledClasses_Expired['WizIQ_presenter_url']; ?>" target="_blank">Class</a></td>
      <td><a href="<?php echo $row_RsGetMyScheduledClasses_Expired['WizIQ_recording_url']; ?>" target="_blank">Download</a></td>
      <td class="small"><?php echo $row_RsGetMyScheduledClasses_Expired['CreateAt']; ?></td>
      <td class="small"><?php echo $row_RsGetMyScheduledClasses_Expired['UpdateAt']; ?></td>
    </tr>
    <?php } while ($row_RsGetMyScheduledClasses_Expired = mysql_fetch_assoc($RsGetMyScheduledClasses_Expired)); ?>
</table>
</div>
<?php } ?>
 
 <!-- End of Expired Classes -->
 
 
<?php
@mysql_free_result($RsGetMyScheduledClasses);
@mysql_free_result($RsGetMyScheduledClasses_Expired);
?>
