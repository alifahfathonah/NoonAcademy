	...
	$i=0;
	 ...
	 ?>
      <tr class="<?php echo $row_bg; ?>">
        <td><a href="index.php?page_id=_teacher_cpanel/delete_library_meterial&ViewID=<?php echo $_GET['ViewID']?>&DeleteID=<?php echo $row_Rs_GetMeterialUploadList['TeacherLibMetrialID']; ?>" onclick="return confirm('Are you sure you want to Edit this record?');"><img src="images/icons/delete.gif" width="16" height="16"></a></td>
