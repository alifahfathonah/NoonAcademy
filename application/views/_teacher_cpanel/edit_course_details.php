...
<div class="data_entry_view">
  ...
  <fieldset>
  <legend><?php echo TEACHER_COURSE_EDIT_DETAILS_HEADING ; ?></legend>
...
?>
      ...
      <tr valign="baseline">
        ...
        <td><?php echo VIEW_LABEL_TEACHER_LIBRARY;?></td>
      </tr>
      <tr valign="baseline">
...
?>
      ...
      <tr valign="baseline">
        <td nowrap><input type="text" name="MaxNoOfStudent" value="<?php echo htmlentities($row_RSGetCourseForEdit['MaxNoOfStudent'], ENT_COMPAT, 'UTF-8'); ?>" size="32"></td>
        <td><input type="text" name="TotalNoOfClasses" value="<?php echo htmlentities($row_RSGetCourseForEdit['TotalNoOfClasses'], ENT_COMPAT, 'UTF-8'); ?>" size="32"></td>
...
<form action="<?php echo $editFormAction; ?>" method="post" enctype="multipart/form-data" name="form2" id="form2">
  ...
  <tr>
    <td><input type="file" name="ContentDataFileName" value="<?php echo htmlentities($row_RSGetCourseForEdit['ContentDataFileName'], ENT_COMPAT, 'UTF-8'); ?>" size="32"><em class="small">* If you want to update the Content File, Please re upload it here </em></td>
  </tr>
    <tr>
    <td> 
