...
<!-- Show Courses Alrady Expired ---->

<?php if( $totalRows_RsCoursesList>0){?>
 <div class="detail_view">
<h3><?php echo VIEW_LABEL_HEADING_EXPIRED_COURSES;?></h3>
...
<td><a href="<?php echo USER_COURSES_UPLOAD_PATH.$row_RsCoursesListExpired['ContentDataFileName'] ?>" target="_blank"><img src="images/icons/download.png" width="16" height="16" /></a></td>        
        <td><?php echo $row_RsCoursesListExpired['SubjectTitle']; ?></td>
        <td><?php echo $row_RsCoursesListExpired['CourseName']; ?></td>
        <td><?php echo $row_RsCoursesListExpired['Description']; ?></td>
        <td class="small"><?php echo $row_RsCoursesListExpired['StartDate']; ?></td>
        <td class="small"><?php echo $row_RsCoursesListExpired['EndDate']; ?></td>
        <td class="small"><?php   if($row_RsCoursesListExpired['IsEnrollable']==1){  ?>
        <img src="images/icons/tick.png" width="16" height="16" /><?php }else{ ?>
        <img src="images/icons/cross.png" width="16" height="16" /> <?php } ?></td>
        <td class="small"><?php echo $row_RsCoursesListExpired['MaxNoOfStudent']; ?></td>
        <td class="small"><?php echo $row_RsCoursesListExpired['TotalNoOfClasses']; ?></td>
        <td class="small"><?php echo $row_RsCoursesListExpired['CourseFee']; ?></td>
      </tr>
      <?php } while ($row_RsCoursesListExpired = mysql_fetch_assoc($RsCoursesListExpired)); ?>
  </table>
...
<!-- End of Show alrady Expired Courses -->

<?php
@mysql_free_result($RsCoursesList);
@mysql_free_result($RsCoursesListExpired);
?>
