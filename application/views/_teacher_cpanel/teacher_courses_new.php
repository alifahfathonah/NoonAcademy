...
<form action="<?php echo $editFormAction; ?>" method="post" enctype="multipart/form-data" name="frm_new_course" id="frm_new_course" accept-charset="utf-8">
 <fieldset>
...
?>
    ...
    <tr valign="baseline">
      <td nowrap align="right"><input type="number" min="1" max="25" name="MaxNoOfStudent" value="25" size="32" required="required"></td>
      <td><input type="number" min="1" max="60" name="TotalNoOfClasses" value="30" size="32" required="required"></td>
      </tr>
    <tr valign="baseline">
