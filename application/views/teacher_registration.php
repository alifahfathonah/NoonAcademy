...
<h2><?php echo TEACHER_ACCOUNT_REGISTRATION_HEADING; ?></h2>
<div class="data_entry_view">
  <form method="post" name="form1" id="form1" action="<?php echo $editFormAction; ?>" accept-charset="utf-8">
  <fieldset><legend><?php echo TEACHER_ACCOUNT_REGISTRATION_TITLE; ?></legend>
    <table width="100%" align="center">
      ...
      <tr valign="baseline">
        <td><input type="text" name="Username" id="Username" value="" size="32" tabindex="1" autofocus required="required">
        <br />
...
?>
      ...
      <tr valign="baseline">
        <td colspan="2">By creating your account you accept our <a href="?page_id=contents/teacher_terms_and_conditions"> Terms &amp; Conditions</a></td>
      </tr>
    </table>
