...
class ScheduleClass
{
	...
	function ScheduleClass1($secretAcessKey,$access_key,$webServiceUrl)
	{
		...
		$requestParameters["presenter_email"]="irfan.khan@yahoo.com";
		...
		$requestParameters["start_time"] = "2013-1-16 10:38";
		...
		$requestParameters["attendee_limit"]="5"; //optional
