...
mysql_select_db($database_conn, $conn);
  $query_Rs_GetMyClasses = sprintf("SELECT  eschool_courses_studdent_wiziq_classes.*, eschool_courses.CourseName FROM eschool_courses_studdent_wiziq_classes, eschool_courses WHERE eschool_courses_studdent_wiziq_classes.StudentUserID = %s AND eschool_courses_studdent_wiziq_classes.CourseID=eschool_courses.CourseID", GetSQLValueString($colname_Rs_GetMyClasses, "int"));
