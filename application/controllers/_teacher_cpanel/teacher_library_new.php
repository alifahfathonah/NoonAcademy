...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $Result1 = mysql_query($insertSQL, $conn) or die(mysql_error());
	...
	//header("Location: index.php?page_id=_teacher_cpanel/teacher_libraries_list&STATUS=LIBRARYCREATED");
	$UploadID=mysql_insert_id();
	header("Location: index.php?page_id=_teacher_cpanel/teacher_upload_lib_meterials&UploadID=$UploadID&STATUS=LIBRARYCREATED");
}
