...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE eschool_courses SET CourseName=%s, `Description`=%s, ContentDataFileName=%s, StartDate=%s, EndDate=%s, IsEnrollable=%s, MaxNoOfStudent=%s, TotalNoOfClasses=%s, CourseFee=%s, TeacherUserID=%s, TeacherLibID=%s, SubjectID=%s WHERE CourseID=%s",
