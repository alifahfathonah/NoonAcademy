...
if (isset($_SESSION['MM_UserID'])) {
  $colname2_Rs_GetLibrary = $_SESSION['MM_UserID'];
}
mysql_select_db($database_conn, $conn);
$query_Rs_GetLibrary = sprintf("SELECT * FROM eschool_teacher_library WHERE TeacherLibID = %s AND eschool_teacher_library.TeacherUserID=%s", GetSQLValueString($colname_Rs_GetLibrary, "int"),GetSQLValueString($colname2_Rs_GetLibrary, "int"));
