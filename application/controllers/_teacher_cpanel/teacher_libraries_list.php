...
$query_RsGetTeachersLibs = sprintf("SELECT * FROM eschool_teacher_library WHERE TeacherUserID = %s ORDER BY  	TeacherLibID DESC ", GetSQLValueString($colname_RsGetTeachersLibs, "int"));
