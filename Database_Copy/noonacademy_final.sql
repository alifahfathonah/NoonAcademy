...
--
-- Host: localhost
-- Generation Time: Feb 04, 2013 at 03:32 PM
...
CREATE TABLE IF NOT EXISTS `eschool_courses_studdent_entrollments` (
  ...
  PRIMARY KEY (`CEID`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Which Student is in What Course can be defined in this table' AUTO_INCREMENT=9 ;
