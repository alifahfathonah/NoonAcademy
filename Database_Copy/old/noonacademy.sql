...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='The Courses that we will offer on the web site' AUTO_INCREMENT=5 ;
...
CREATE TABLE IF NOT EXISTS `eschool_courses_classes` (
  ...
  PRIMARY KEY (`ClassID`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='To record the classes details created in the WizIQ Server' AUTO_INCREMENT=6 ;
...
CREATE TABLE IF NOT EXISTS `eschool_courses_studdent_entrollments` (
  ...
  PRIMARY KEY (`CEID`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Which Student is in What Course can be defined in this table' AUTO_INCREMENT=5 ;
...
(3, 4, 12, 2, 2, '2013-02-03 09:04:17', '2013-02-03 06:04:17'),
(4, 4, 3, 2, 2, '2013-02-03 09:04:17', '2013-02-03 06:04:17');
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='List of Classess Schedule at WizIQ Server' AUTO_INCREMENT=11 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='The Name of the Library of a Teacher' AUTO_INCREMENT=3 ;
