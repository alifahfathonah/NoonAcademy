...
--
-- Host: localhost
-- Generation Time: Feb 07, 2013 at 10:58 PM
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='The Courses that we will offer on the web site' AUTO_INCREMENT=8 ;
...
CREATE TABLE IF NOT EXISTS `eschool_courses_classes` (
  ...
  PRIMARY KEY (`ClassID`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='To record the classes details created in the WizIQ Server' AUTO_INCREMENT=9 ;
...
CREATE TABLE IF NOT EXISTS `eschool_courses_studdent_entrollments` (
  ...
  PRIMARY KEY (`CEID`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Which Student is in What Course can be defined in this table' AUTO_INCREMENT=13 ;
...
(6, 5, 3, 0, 3, '2013-02-04 12:30:33', '2013-02-04 09:30:33', 0),
(7, 6, 3, 2, 2, '2013-02-04 14:02:05', '2013-02-04 11:02:05', 0),
...
(12, 7, 3, 0, 3, '2013-02-08 01:48:49', '2013-02-07 22:48:49', 0);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='List of Classess Schedule at WizIQ Server' AUTO_INCREMENT=18 ;
...
--
-- Table structure for table `eschool_view_student_list_with_no_wiziq_classes`
--

DROP TABLE IF EXISTS `eschool_view_student_list_with_no_wiziq_classes`;
CREATE ALGORITHM=UNDEFINED DEFINER=`admin`@`localhost` SQL SECURITY DEFINER VIEW `noonacademy`.`eschool_view_student_list_with_no_wiziq_classes` AS select `eschool_view_enrolled_students`.`UserID` AS `UserID`,`eschool_view_enrolled_students`.`FirstName` AS `FirstName`,`eschool_view_enrolled_students`.`LastNames` AS `LastNames`,`eschool_view_enrolled_students`.`CEID` AS `CEID`,`eschool_view_enrolled_students`.`CourseID` AS `CourseID`,`eschool_view_enrolled_students`.`StudentUserID` AS `StudentUserID`,`eschool_view_enrolled_students`.`TeacherUserID` AS `TeacherUserID`,`eschool_view_enrolled_students`.`WhoUserID` AS `WhoUserID`,`eschool_view_enrolled_students`.`CreateAt` AS `CreateAt`,`eschool_view_enrolled_students`.`UpdatedAt` AS `UpdatedAt` from (`noonacademy`.`eschool_view_enrolled_students` left join `noonacademy`.`eschool_courses_studdent_wiziq_classes` on((`noonacademy`.`eschool_courses_studdent_wiziq_classes`.`StudentUserID` = `eschool_view_enrolled_students`.`StudentUserID`))) where isnull(`noonacademy`.`eschool_courses_studdent_wiziq_classes`.`StudentUserID`);
-- Error reading data: (#1356 - View 'noonacademy.eschool_view_student_list_with_no_wiziq_classes' references invalid table(s) or column(s) or function(s) or definer/invoker of view lack rights to use them)
...
CREATE TABLE IF NOT EXISTS `user_accounts` (
  ...
  KEY `UserID` (`UserID`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='UserAccounts' AUTO_INCREMENT=14 ;
...
(3, 'studentkhan', '123', 'Student', 'جل الآن للفو', 'جوابرة', 'Welcome', 'to', 'Riyadh', 191, '009265354855', 'student@student.com', 'http://www.yahoo.com', NULL, '0096654566666', NULL, '4_24011323113599880afc4e5c661d7c80d381adf8b5a030224.jpg', 3, 1, '127.0.0.1', NULL, NULL, '2013-01-13 11:41:49', '2013-02-04 11:56:58', 1),
