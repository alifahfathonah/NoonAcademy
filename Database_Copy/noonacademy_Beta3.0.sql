...
--
-- Host: localhost
-- Generation Time: Feb 10, 2013 at 07:50 AM
...
--
-- Stand-in structure for view `enrolled_students_list`
--
DROP VIEW IF EXISTS `enrolled_students_list`;
CREATE TABLE IF NOT EXISTS `enrolled_students_list` (
`UserID` bigint(20)
,`CEID` int(11)
,`CourseID` bigint(20)
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='The Courses that we will offer on the web site' AUTO_INCREMENT=9 ;
...
(3, 'Advance Web Apps', 'How to Develop Advance Web Applications', '2_020213322222225010b4bfe50947c52305544b3a1c1dd6396.pdf', '2013-02-02', '2013-02-03', 1, 25, 30, 5000, 2, 2, 2),
(4, 'web', 'web', '2_030213330951900710b4bfe50947c52305544b3a1c1dd6396.pdf', '2013-02-03', '2013-02-04', 1, 25, 30, 500, 2, 2, 4),
(5, 'Botanical Plants', 'Botanical Plants', '2_040213341211732500b4bfe50947c52305544b3a1c1dd6396.pdf', '2013-02-04', '2013-02-06', 1, 25, 30, 600, 2, 3, 2),
(6, 'Analytically Chemistry ', 'Chemistry ', '2_040213341434878470b4bfe50947c52305544b3a1c1dd6396.pdf', '2013-02-04', '2013-02-07', 1, 25, 30, 500, 2, 3, 1),
(7, 'Advance PHP', 'Advance PHP', 'none.jpg', '2013-02-08', '2013-02-09', 1, 25, 30, 500, 2, 2, 4),
(8, 'Advance PHP Web Dev', 'Advance PHP Application Development', '2_100213401043606090b4bfe50947c52305544b3a1c1dd6396.pdf', '2013-02-10', '2013-02-11', 1, 25, 2, 500, 2, 2, 4);
...
CREATE TABLE IF NOT EXISTS `eschool_courses_classes` (
  ...
  PRIMARY KEY (`ClassID`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='To record the classes details created in the WizIQ Server' AUTO_INCREMENT=12 ;
...
(5, 4, 2, '1278423', '2013-02-04 10:00:00', 45, 'http://authorlive.com/aliveext/LoginToSession.aspx?SessionCode=F7BGDeMLTGhTVuUQwNzOJA%3d%3d', 'http://authorlive.com/aliveext/Recorded.aspx?SessionCode=j5vXTyLTH%2bM%3d', '2013-02-03 09:04:53', '0000-00-00 00:00:00', 2),
(6, 4, 2, '1278529', '2013-02-03 13:36:00', 45, 'http://authorlive.com/aliveext/LoginToSession.aspx?SessionCode=eGcPvDBGZlM%2bgz3uTW4lwA%3d%3d', 'http://authorlive.com/aliveext/Recorded.aspx?SessionCode=oG8TPyoYixk%3d', '2013-02-03 13:22:53', '0000-00-00 00:00:00', 2),
(7, 4, 2, '1278530', '2013-02-04 13:36:00', 45, 'http://authorlive.com/aliveext/LoginToSession.aspx?SessionCode=PVLmc8lesMcu0%2fBSE1j2%2bg%3d%3d', 'http://authorlive.com/aliveext/Recorded.aspx?SessionCode=CCLrXYdja%2fE%3d', '2013-02-03 13:22:58', '0000-00-00 00:00:00', 2),
(8, 7, 2, '1286351', '2013-02-08 01:50:00', 45, 'http://authorlive.com/aliveext/LoginToSession.aspx?SessionCode=A%2f3Rv6Q1lrWbv632oJ8hJg%3d%3d', 'http://authorlive.com/aliveext/Recorded.aspx?SessionCode=OpO75YlYzn0%3d', '2013-02-08 01:47:41', '0000-00-00 00:00:00', 2),
(9, 7, 2, '1286426', '2013-02-08 02:32:00', 45, 'http://authorlive.com/aliveext/LoginToSession.aspx?SessionCode=fKVVd3zOI6mR3HlLlE9IsQ%3d%3d', 'http://authorlive.com/aliveext/Recorded.aspx?SessionCode=58tjEbzK%2bsI%3d', '2013-02-08 02:30:32', '0000-00-00 00:00:00', 2),
(10, 8, 2, '1288794', '2013-02-10 10:37:00', 45, 'http://authorlive.com/aliveext/LoginToSession.aspx?SessionCode=u7o2UUB%2fURHLMzwe%2frkWxw%3d%3d', 'http://authorlive.com/aliveext/Recorded.aspx?SessionCode=D49o%2fygTo9k%3d', '2013-02-10 10:33:53', '0000-00-00 00:00:00', 2),
(11, 8, 2, '1288795', '2013-02-11 05:10:00', 45, 'http://authorlive.com/aliveext/LoginToSession.aspx?SessionCode=e3%2ffLyguvR0roXXLYWLRJA%3d%3d', 'http://authorlive.com/aliveext/Recorded.aspx?SessionCode=iG66y0hdEfo%3d', '2013-02-10 10:33:57', '0000-00-00 00:00:00', 2);
...
CREATE TABLE IF NOT EXISTS `eschool_courses_studdent_entrollments` (
  ...
  PRIMARY KEY (`CEID`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Which Student is in What Course can be defined in this table' AUTO_INCREMENT=14 ;

--
-- Dumping data for table `eschool_courses_studdent_entrollments`
--

INSERT INTO `eschool_courses_studdent_entrollments` (`CEID`, `CourseID`, `StudentUserID`, `TeacherUserID`, `WhoUserID`, `CreateAt`, `UpdatedAt`, `IsPaid`) VALUES
(1, 2, 12, 0, 12, '2013-01-30 23:25:02', '2013-02-04 09:09:00', 1),
(2, 2, 3, 0, 3, '2013-01-30 23:26:00', '2013-02-04 09:09:00', 1),
(3, 4, 12, 2, 2, '2013-02-03 09:04:17', '2013-02-04 09:08:30', 1),
(4, 4, 3, 2, 2, '2013-02-03 09:04:17', '2013-02-04 09:09:00', 1),
(5, 4, 11, 2, 2, '2013-02-03 13:21:16', '2013-02-04 09:05:52', 1),
(6, 5, 3, 0, 3, '2013-02-04 12:30:33', '2013-02-10 07:05:13', 1),
(7, 6, 3, 2, 2, '2013-02-04 14:02:05', '2013-02-10 07:05:29', 1),
(8, 5, 13, 2, 2, '2013-02-04 14:53:37', '2013-02-04 11:53:37', 0),
(9, 6, 13, 2, 2, '2013-02-04 23:35:06', '2013-02-04 20:35:06', 0),
(10, 6, 12, 2, 2, '2013-02-06 09:16:49', '2013-02-06 06:16:49', 0),
(11, 6, 11, 2, 2, '2013-02-06 09:16:49', '2013-02-06 06:16:49', 0),
(12, 7, 3, 0, 3, '2013-02-08 01:48:49', '2013-02-10 07:06:27', 1),
(13, 8, 14, 0, 14, '2013-02-10 10:37:43', '2013-02-10 07:38:21', 1);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='List of Classess Schedule at WizIQ Server' AUTO_INCREMENT=21 ;
...
(5, 4, 3, '1278423', NULL, '3', 'http://authorlive.com/aliveext/LoginToSession.aspx?SessionCode=J8zyLD5y4jJ9r3v0SIp%2ftg%3d%3d', 2, '2013-02-03 09:17:44', '2013-02-03 06:17:44'),
(6, 4, 12, '1278423', NULL, '12', 'http://authorlive.com/aliveext/LoginToSession.aspx?SessionCode=J8zyLD5y4jI1maNJVoW2JQ%3d%3d', 2, '2013-02-03 09:17:44', '2013-02-03 06:17:44'),
(7, 4, 3, '1278423', NULL, '3', 'http://authorlive.com/aliveext/LoginToSession.aspx?SessionCode=J8zyLD5y4jL5D0gTNXU1kQ%3d%3d', 2, '2013-02-03 09:37:20', '2013-02-03 06:37:20'),
(8, 4, 12, '1278423', NULL, '12', 'http://authorlive.com/aliveext/LoginToSession.aspx?SessionCode=J8zyLD5y4jI%2f3%2bhpUgji5A%3d%3d', 2, '2013-02-03 09:37:20', '2013-02-03 06:37:20'),
(9, 4, 3, '1278423', NULL, '3', 'http://authorlive.com/aliveext/LoginToSession.aspx?SessionCode=J8zyLD5y4jI4D5n%2bIJA69A%3d%3d', 2, '2013-02-03 09:37:21', '2013-02-03 06:37:21'),
(10, 4, 12, '1278423', NULL, '12', 'http://authorlive.com/aliveext/LoginToSession.aspx?SessionCode=J8zyLD5y4jLtGchQvXHr%2bw%3d%3d', 2, '2013-02-03 09:37:22', '2013-02-03 06:37:22'),
(11, 4, 11, '1278529', NULL, '11', 'http://authorlive.com/aliveext/LoginToSession.aspx?SessionCode=KflWrqLquTHLb0v%2bRuli0Q%3d%3d', 2, '2013-02-03 13:24:57', '2013-02-03 10:24:57'),
(12, 4, 3, '1278529', NULL, '3', 'http://authorlive.com/aliveext/LoginToSession.aspx?SessionCode=KflWrqLquTGjq%2f8zTh8m3w%3d%3d', 2, '2013-02-03 13:24:58', '2013-02-03 10:24:58'),
(13, 4, 12, '1278529', NULL, '12', 'http://authorlive.com/aliveext/LoginToSession.aspx?SessionCode=KflWrqLquTHN1OoJCOmz8g%3d%3d', 2, '2013-02-03 13:24:58', '2013-02-03 10:24:58'),
(14, 4, 11, '1278529', NULL, '11', 'http://authorlive.com/aliveext/LoginToSession.aspx?SessionCode=KflWrqLquTEdaYeG3BmsiQ%3d%3d', 2, '2013-02-03 13:25:16', '2013-02-03 10:25:16'),
(15, 4, 3, '1278529', NULL, '3', 'http://authorlive.com/aliveext/LoginToSession.aspx?SessionCode=KflWrqLquTExxhfl%2f%2fKXiA%3d%3d', 2, '2013-02-03 13:25:17', '2013-02-03 10:25:17'),
(16, 4, 12, '1278529', NULL, '12', 'http://authorlive.com/aliveext/LoginToSession.aspx?SessionCode=KflWrqLquTHJomMajalxeg%3d%3d', 2, '2013-02-03 13:25:17', '2013-02-03 10:25:17'),
(17, 7, 3, '1286351', NULL, '3', 'http://authorlive.com/aliveext/LoginToSession.aspx?SessionCode=UtpAHha0pvIbcIe8Vymr0Q%3d%3d', 2, '2013-02-08 01:49:13', '2013-02-07 22:49:13'),
(18, 7, 3, '1286426', NULL, '3', 'http://authorlive.com/aliveext/LoginToSession.aspx?SessionCode=4HyUP5worsd0PkT94sQl2g%3d%3d', 2, '2013-02-08 02:31:41', '2013-02-07 23:31:41'),
(19, 8, 14, '1288794', NULL, '14', 'http://authorlive.com/aliveext/LoginToSession.aspx?SessionCode=579w%2f7sQmSjwoAv2jemyuw%3d%3d', 2, '2013-02-10 10:39:49', '2013-02-10 07:39:49'),
(20, 8, 14, '1288795', NULL, '14', 'http://authorlive.com/aliveext/LoginToSession.aspx?SessionCode=YXNbglV3rIIooCL06TQuaQ%3d%3d', 2, '2013-02-10 10:40:21', '2013-02-10 07:40:21');
...
(2, 'Web Programming with PHP', 'Learning the PHP Advance Level Web Development. ', 2, '2013-02-02 22:03:27', '0000-00-00 00:00:00'),
(3, 'مكتبة جديده', ' تست', 2, '2013-02-03 13:17:52', '0000-00-00 00:00:00');
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='The Item Added to the Library by a Teacher or Admin' AUTO_INCREMENT=8 ;
...
(7, 2, '2_020213322217417690b4bfe50947c52305544b3a1c1dd6396.pdf', 'Basic PHP Development', 0, 1, '2013-02-02 22:07:17', '2013-02-02 19:07:17');
...
CREATE TABLE IF NOT EXISTS `news` (
  ...
  `Content_LanguageID` int(3) NOT NULL DEFAULT '1',
  PRIMARY KEY (`NewsID`)
...
INSERT INTO `news` (`NewsID`, `NewsTitle`, `NewsText`, `CreatedAt`, `WhoUserID`, `Content_LanguageID`) VALUES
(1, 'Welcome', 'Welcome to Noon Academy', '2013-02-06 12:11:40', 1, 1),
(2, 'Welcome', 'Welcome to Noon Academy', '2013-02-06 12:12:00', 1, 1),
(3, 'Welcome', 'Welcome to Noon Academy', '2013-02-06 12:12:18', 1, 1),
(4, 'Welcome', 'Welcome to Noon Academy', '2013-02-06 12:13:25', 1, 1),
(5, 'Welcome', 'Welcome to Noon Academy', '2013-02-06 12:15:17', 1, 1),
(10, 'dsfsd', 'sddfsd', '2013-02-06 19:34:54', 1, 2);
...
(1, 'test@test.com', '2013-02-05 06:00:06');
...
CREATE TABLE IF NOT EXISTS `user_accounts` (
  ...
  KEY `UserID` (`UserID`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='UserAccounts' AUTO_INCREMENT=15 ;
...
(3, 'student', '123', 'Student', 'جل الآن للفو', 'جوابرة', 'Welcome', 'to', 'Riyadh', 191, '009265354855', 'student@student.com', 'http://www.yahoo.com', NULL, '0096654566666', NULL, '4_24011323113599880afc4e5c661d7c80d381adf8b5a030224.jpg', 3, 1, '127.0.0.1', NULL, NULL, '2013-01-13 11:41:49', '2013-02-08 11:36:57', 1),
...
(14, 'student3', '123', 'Student', 'Khan', 'Khan', 'Peshawar', 'PK', 'Malakand', 191, '0547585452', 'kifayatkhan@student.com', 'www.zorkif.com', NULL, '12334', NULL, NULL, 3, 1, '127.0.0.1', NULL, NULL, '2013-02-10 10:36:12', '0000-00-00 00:00:00', 1),
(2, 'teacher', '123', 'Kifayat', 'ullah', 'Khan', 'Office No1', 'Ground Floor, Ibni Khatir Road', 'Riyadh', 191, '00966545883076', 'irfan.khan@yahoo.com', 'http://www.zorlkif.com', NULL, '00966545883076', NULL, '2_2401132311219924328d704546e70b414f74b3bcc214f3922.jpg', 2, 1, '127.0.0.1', NULL, NULL, '2013-01-08 22:58:48', '2013-02-03 06:01:28', 1),
(13, 'ttttt', '123', 'Student', 'sdfsdf', 'student@cdd.com', 'student', 'sdfsdf', 'student@cdd.com', 191, 'student@cdd.com', 'student@cdd.com', 'student@cdd.com', NULL, 'student@cdd.com', NULL, NULL, 3, 1, '127.0.0.1', NULL, NULL, '2013-02-04 10:40:57', '0000-00-00 00:00:00', 1);
...
--
-- Structure for view `enrolled_students_list`
--
DROP TABLE IF EXISTS `enrolled_students_list`;

CREATE ALGORITHM=UNDEFINED DEFINER=`admin`@`localhost` SQL SECURITY DEFINER VIEW `enrolled_students_list` AS select `user_accounts`.`UserID` AS `UserID`,`eschool_courses_studdent_entrollments`.`CEID` AS `CEID`,`eschool_courses_studdent_entrollments`.`CourseID` AS `CourseID`,`eschool_courses_studdent_entrollments`.`StudentUserID` AS `StudentUserID`,`eschool_courses_studdent_entrollments`.`TeacherUserID` AS `TeacherUserID`,`eschool_courses_studdent_entrollments`.`WhoUserID` AS `WhoUserID`,`eschool_courses_studdent_entrollments`.`CreateAt` AS `CreateAt`,`eschool_courses_studdent_entrollments`.`UpdatedAt` AS `UpdatedAt`,`eschool_courses_studdent_entrollments`.`IsPaid` AS `IsPaid` from (`eschool_courses_studdent_entrollments` join `user_accounts`) where (`eschool_courses_studdent_entrollments`.`StudentUserID` = `user_accounts`.`UserID`);
