...
--
-- Host: localhost
-- Generation Time: Feb 04, 2013 at 09:11 PM
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='The Courses that we will offer on the web site' AUTO_INCREMENT=7 ;
...
CREATE TABLE IF NOT EXISTS `eschool_courses_classes` (
  ...
  PRIMARY KEY (`ClassID`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='To record the classes details created in the WizIQ Server' AUTO_INCREMENT=8 ;
...
CREATE TABLE IF NOT EXISTS `eschool_courses_studdent_entrollments` (
  ...
  PRIMARY KEY (`CEID`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Which Student is in What Course can be defined in this table' AUTO_INCREMENT=10 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='List of Classess Schedule at WizIQ Server' AUTO_INCREMENT=17 ;
